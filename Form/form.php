...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $penjaga_id = $_POST['penjaga_id']; // Pastikan key-nya sesuai dengan atribut name di form

    // Query untuk menambah siswa
    $sql = "INSERT INTO calon_siswa (nama, jenis_kelamin, alamat, email, sekolah_asal, penjaga_id)
            VALUES ('$nama', '$jenis_kelamin', '$alamat', '$email', '$sekolah_asal', $penjaga_id)";
